...
13. Enrichment: settle-then-run (60s), coalescing, utility model, never creates characters, unrecognized names reported.
...
3. **Plotline deletion:** blocked while scenes linked.
