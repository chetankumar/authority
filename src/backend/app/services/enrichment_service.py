    ...
    def _summary_prompt(scene: Any, prose: str) -> str:
        return "\n".join(
            [
                ...
                "The studio will show the author what you saved, so don't repeat the summary",
                "in chat. A brief note or a question is fine.",
    ...
    def _characters_prompt(scene: Any, prose: str, directory: str, existing: str) -> str:
        return "\n".join(
            [
                ...
                "The studio will show the author the list you saved, so don't repeat names and",
                "involvement in chat. A brief note or a question is fine.",
                "",
