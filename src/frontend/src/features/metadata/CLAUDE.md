...
- **Book:** Story summary textarea · System prompt textarea (hint "Prepended to every AI request for this book") · Bookkeeping toggles · Search index (status, Rebuild, Delete) · [Save] → `PATCH /books/{id}`.
